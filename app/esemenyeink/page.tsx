...
export default function Esemeneink() {
  ...
  return (
    <main className="max-w-7xl mx-auto px-2 sm:px-4 py-8 md:py-12">
      ...
      >
        <div className="relative overflow-hidden rounded-3xl border border-white/15 bg-[#020618] shadow-[0_30px_70px_-40px_rgba(0,0,0,0.65)] p-6 md:p-12 mx-0">
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col justify-center p-6 md:p-8 bg-white">
              <p className="text-black mb-6 line-clamp-5 leading-[1.6]">{featuredEvent.description}</p>
