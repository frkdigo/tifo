							...
							<div className="grid md:grid-cols-[1.2fr,0.8fr]">
								...
								<div className="p-6 flex flex-col justify-between">
									...
									<div className="mt-4">
										...
										<button
											className="w-full bg-blue-900 text-white py-2.5 rounded-xl hover:bg-blue-800 transition-colors font-semibold"
								...
								{upcoming.map((event) => (
									<article key={event.id} className="rounded-2xl border border-gray-200 bg-white shadow-[0_14px_35px_-22px_rgba(13,59,102,0.22)] overflow-hidden flex flex-col h-[360px]">
										...
										<div className="p-4 flex-1 min-h-0 flex flex-col">
											...
											<button
												className="mt-3 w-full bg-blue-900 text-white py-2 rounded-xl hover:bg-blue-800 transition-colors font-semibold shrink-0"
							...
							<div className="space-y-3">
								{past.slice(0, 6).map((event) => (
									<div key={event.id} className="rounded-xl border border-gray-200 bg-white px-4 py-3 shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
										...
										<button
											className="text-sm bg-blue-900 hover:bg-blue-800 text-white px-3 py-1.5 rounded-xl transition-colors"
											onClick={() => setSelected(event)}
										>
											Megnézem
										</button>
