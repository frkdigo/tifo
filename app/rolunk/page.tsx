  ...
  return (
    ...
    >
      ...
      <motion.section
        ...
        transition={{ duration: 0.7, ease: "easeOut" }}
      >
        <div className="relative overflow-hidden rounded-3xl border border-white/15 bg-blue-900 shadow-[0_30px_70px_-40px_rgba(0,0,0,0.65)] p-8 md:p-12 text-center">
