  ...
  return (
    <footer className="relative mt-8 border-t border-slate-800 bg-slate-950 text-slate-200 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4 py-5">
        <div className="grid gap-4 md:grid-cols-[1.2fr_0.8fr_0.8fr]">
          ...
          <section>
            ...
            <ul className="space-y-1 text-xs text-slate-300">
              <li>
                Email:{' '}
                <a href="mailto:info@tifo.hu" className="hover:text-sky-300 transition-colors">
                  info@tifo.hu
                </a>
              </li>
              <li>
        ...
        <div className="mt-4 pt-2 border-t border-slate-800 text-[10px] text-slate-400 flex flex-col sm:flex-row gap-1 sm:items-center sm:justify-between">
          <span>© {year} Törökbálinti Ifjúsági Önkormányzat</span>
          <span className="text-slate-500">Minden jog fenntartva.</span>
        </div>
      </div>
    </footer>
  );
